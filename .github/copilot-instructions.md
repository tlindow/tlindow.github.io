...
This repository powers **Tyler Lindow's workspace**, organized into two core pillars:
1. **`content/`** — Personal journal entries, essays, and published post repository (public and private drafts).
2. **`site/`** — The living Next.js application powering Tyler's personal website and interactive portfolio.
...
4. **PR-Based Content Publishing**: The `content/` directory is managed via a Pull Request workflow so that new content broadcasts public activity to GitHub followers as a publishing feed.
