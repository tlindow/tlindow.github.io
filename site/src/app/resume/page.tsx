...
export const metadata: Metadata = {
  ...
  description:
    "Web-based and printable resume for Tyler Lindow. Staff B2B Product Manager — B2B Fintech on DevX Rails. $10B+ partner portfolio scale, Affirm, and developer paved paths.",
};
