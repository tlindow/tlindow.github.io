...
- Shipped a 0→1 fundraising pitch simulator (React/Next.js) as founder of Beginner Work Inc.—discovery through GTM in four months; validated with 10+ product interviews and a 20+ engineer community across SoCal, NYC, and SF. Closed the company when ready to return as an engineering leader building inside a company again.
